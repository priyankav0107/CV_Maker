		...
		<div id="container">
			<div id="left-div">
				...
				<div id="left-bottom-div">
					<h1 id="skills"><img src="Image/skills-logo.png" id="skills-logo"> Skills</h1>
			...
			<div id="right-div">
				<div id="right-top-div">
					...
					<h3 id="name-institute"><?php echo "$companyname";?></h3>
				...
				<div id="right-bottom-div">
					...
					<div id="varsity-div">
						<h3 id="name-institute"><?php echo "$varsityname";?></h3>
						<h5 class="description">CGPA: <?php echo "$cgpa";?></h5>
						<h5 class="description"><?php echo "$varsitypyear";?></h5>
					</div></br><br>
					<div id="college-div">
						<h3 id="name-institute"><?php echo "$collegename";?></h3>
						<h5 class="description">GPA: <?php echo "$hscgpa";?></h5>
						<h5 class="description"><?php echo "$clgpyear";?></h5>
					</div></br><br>
					<div id="school-div">
						<h3 id="name-institute"><?php echo "$schoolname";?></h3>
						<h5 class="description">GPA: <?php echo "$sscgpa";?></h5>
						<h5 class="description"><?php echo "$sclpyear";?></h5>
					</div><br> 
				</div>
			</div>
			<br><div class="text-center">
        <a href="print.php" class="btn btn-primary">Save and Print</a>
     </div>
		</div>
		<footer>
			<p>&copy; 2021 - DataPirates</p>
		</footer>
	</form>
